...
name: vibe-upgrade
description: >-
  Launch Vibe: Upgrade through the canonical governed Vibe runtime.
---
...
Wrapper entry: Vibe: Upgrade (`vibe-upgrade`)
...
py -3 -m vgo_cli.main upgrade --repo-root $repoRoot --host claude-code --target-root $targetRoot --frontend powershell --profile full
```
